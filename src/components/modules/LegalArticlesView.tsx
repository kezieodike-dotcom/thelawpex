    ...
    <div className="bg-white text-neutral-900 min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-yellow-100 border border-yellow-400/70 rounded-2xl p-6 sm:p-8 mb-8 shadow-xl">
          ...
          <h1 className="text-2xl sm:text-4xl font-black font-serif text-neutral-900 mt-2">Peer-Reviewed Legal Articles & Journals</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-3">
            <h2 className="text-xs font-bold text-yellow-700 uppercase tracking-wider mb-2">Featured Research Papers</h2>
            {LEGAL_ARTICLES.map((art) => (
              ...
              >
                <span className="text-[10px] text-yellow-700 font-bold uppercase">{art.category}</span>
                <h3 className="text-xs font-bold font-serif text-neutral-900 line-clamp-2 mt-1">{art.title}</h3>
                <p className="text-[11px] text-neutral-600 mt-1">{art.author}</p>
          ...
          <div className="lg:col-span-2">
            <div className="bg-yellow-100 border border-neutral-200 p-6 sm:p-8 rounded-2xl space-y-6 shadow-2xl">
              <div className="border-b border-neutral-200 pb-4">
                ...
                <h1 className="text-2xl font-black font-serif text-neutral-900 mt-2 leading-tight">{selectedArticle.title}</h1>
                <div className="flex flex-wrap items-center gap-4 text-xs text-neutral-600 mt-3">
              ...
              <div className="prose prose-invert max-w-none text-xs sm:text-sm text-neutral-700 font-serif leading-relaxed whitespace-pre-wrap">
